...
namespace Custom_Monkey_Names

{
    public class Main : MelonMod
    {
        private static readonly string Dir = $"{Directory.GetCurrentDirectory()}\\Mods\\CustomMonkeyNames";
        ...
        public override void OnApplicationStart()
        {
            ...
            MelonLogger.Log("Custom Monkey Names mod loaded!");
        }
